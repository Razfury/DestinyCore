...
void BattlepayManager::ProcessDelivery(Purchase * purchase)
{
    ...
    case Battlepay::Level:
    {
        if (player)
        {
            ...
            player->SetLevel(90);
            player->AddItem(14046, 4);
            player->AddQuest(sObjectMgr->GetQuestTemplate(34398), nullptr); // The Dark Portal quest.
            player->AddQuest(sObjectMgr->GetQuestTemplate(36881), nullptr); // The Dark Portal quest.

            // Lambda function to safely add items only if they exist in the DB
            auto SafeAddItem = [&](uint32 itemId) {
                if (itemId == 0)
                    return;
                ...
                {
                    TC_LOG_ERROR("server", "Battlepay: Item ID %u not found in item_template. Skipping to prevent crash.", itemId);
                }
                };
            ...
            {
                SafeAddItem(86181); // Headx
                SafeAddItem(86205); // Neckx
                SafeAddItem(89833); // Shouldersx
                SafeAddItem(42360); // Tabard
                SafeAddItem(86169); // Cloakx
                SafeAddItem(86513); // Chestx
                SafeAddItem(86161); // Glovesx
                SafeAddItem(86210);  // Waistx
                SafeAddItem(86229); // Legsx
                SafeAddItem(86167); // Bootsx
                SafeAddItem(86156); // Ring 1x
                SafeAddItem(86211); // Ring 2x
                SafeAddItem(86388); // Trinket 1x
                SafeAddItem(86133); // Trinket 2x
                SafeAddItem(86335); // 2H Wep INTELx
                SafeAddItem(86157);  // Bracersx
                player->GetSession()->LogoutPlayer(true);
            }
            // --- LEATHER (Rogue, Druid, Monk, Demon Hunter) ---
            else if (player->getClass() == CLASS_ROGUE || player->getClass() == CLASS_DRUID || player->getClass() == CLASS_MONK)
            {
                SafeAddItem(86146); // Headx
                SafeAddItem(86166); // Neckx
                SafeAddItem(89836); // Shouldersx
                SafeAddItem(42360); // Tabard
                SafeAddItem(86173); // Cloakx
                SafeAddItem(89886); // Chestx
                SafeAddItem(89842); // Glovesx
                SafeAddItem(86341);  // Waistx
                SafeAddItem(89884); // Legsx
                SafeAddItem(86320); // Bootsx
                SafeAddItem(86231); // Ring 1x
                SafeAddItem(86200); // Ring 2x
                SafeAddItem(86332); // Trinket 1x
                SafeAddItem(86132); // Trinket 2x
                SafeAddItem(86391); // 1 Hand Wepx
                SafeAddItem(86391); // 1 Hand Wepx
                SafeAddItem(86071); // 2H Wep AGIL
                SafeAddItem(86335); // 2H Wep INTEL
                SafeAddItem(86163);  // Bracersx
                player->GetSession()->LogoutPlayer(true);
            }
            // --- MAIL (Hunter, Shaman) ---
            else if (player->getClass() == CLASS_HUNTER || player->getClass() == CLASS_SHAMAN)
            {
                SafeAddItem(86228); // Head
                SafeAddItem(86166); // Neck
                SafeAddItem(86204); // Shoulders
                SafeAddItem(42360); // Tabard
                SafeAddItem(86173); // Cloak
                SafeAddItem(86160); // Chest
                SafeAddItem(86175); // Gloves
                SafeAddItem(86342);  // Waist ny
                SafeAddItem(89830); // Legs
                SafeAddItem(86214); // Boots
                SafeAddItem(86200); // Ring 1
                SafeAddItem(90517); // Ring 2
                SafeAddItem(86332); // Trinket 1
                SafeAddItem(86132); // Trinket 2
                SafeAddItem(86226); // 1 Hand Wep
                SafeAddItem(86226); // 1 Hand Wep
                SafeAddItem(86331); // BOW
                SafeAddItem(86335); // 2H Wep INTEL
                SafeAddItem(86168);  // Bracers
                player->GetSession()->LogoutPlayer(true);
            }
            // --- PLATE (Warrior, Paladin, Death Knight) ---
            else if (player->getClass() == CLASS_WARRIOR || player->getClass() == CLASS_PALADIN || player->getClass() == CLASS_DEATH_KNIGHT)
            {
                SafeAddItem(86174); // Head
                SafeAddItem(86177); // Neck
                SafeAddItem(89828); // Shoulders
                SafeAddItem(42360); // Tabard
                SafeAddItem(86202); // Cloak
                SafeAddItem(86158); // Chest
                SafeAddItem(86179); // Gloves
                SafeAddItem(86164);  // Waist
                SafeAddItem(86203); // Legs
                SafeAddItem(86201); // Boots
                SafeAddItem(86162); // Ring 1
                SafeAddItem(86155); // Ring 2
                SafeAddItem(86336); // Trinket 1
                SafeAddItem(86323); // Trinket 2
                SafeAddItem(86219); // 1 Hand Wep
                SafeAddItem(86219); // 1 Hand Wep
                SafeAddItem(86140); // 2H Wep
                SafeAddItem(86027);  // Bracers
                SafeAddItem(85996);  // Shield
                player->GetSession()->LogoutPlayer(true);
            }
        }
